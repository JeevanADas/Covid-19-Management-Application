...
public class vaccination_cancel_appointment_page extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					vaccination_cancel_appointment_page frame = new vaccination_cancel_appointment_page();
	 ...
	 * Create the frame.
	 */
	public vaccination_cancel_appointment_page() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try
				{
				    ...
				    PreparedStatement ps = conn.prepareStatement("DELETE FROM covid19_management_application.vaccination where phno = ? ;");
					ps.setString(1, phno);
