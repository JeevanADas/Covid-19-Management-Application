...
public class testing_booking_appointment_page extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					testing_booking_appointment_page frame = new testing_booking_appointment_page();
	 ...
	 * Create the frame.
	 */
	public testing_booking_appointment_page() {
		...
		JLabel lblNewLabel6_1 = new JLabel("Date of testing:");
		lblNewLabel6_1.setFont(new Font("Arial Narrow", Font.BOLD, 15));
		lblNewLabel6_1.setBounds(338, 212, 186, 19);
		contentPane.add(lblNewLabel6_1);
		...
		JLabel lblNewLabel6 = new JLabel("Select Lab Location");
		lblNewLabel6.setFont(new Font("Arial Narrow", Font.BOLD, 15));
		lblNewLabel6.setBounds(207, 361, 186, 19);
		...
		bookappointment_btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Class.forName("com.mysql.cj.jdbc.Driver");
					Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/covid19_management_application","root","password@mysql");
					PreparedStatement ps = conn.prepareStatement("insert into covid19_management_application.testing(phno,name,age,city,labarea,date,result,labid) values (?,?,?,?,?,?,?,?);");
					ps.setString(1, phno);
